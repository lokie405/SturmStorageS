...
//    val robotoRegular = FontFamily( Font(R.font.roboto_regular, FontWeight.Normal) )
    ...
    //  --- Font without ukrainian ---
    val digitPlay = FontFamily(Font(R.font.digit_play, FontWeight.Medium))
    val sairaSemiBold = FontFamily(Font(R.font.saira_condensed_semi_bold, FontWeight.SemiBold))
    val michromaRegular = FontFamily(Font(R.font.michroma_regular, FontWeight.Normal))
    val tekturSemiBold = FontFamily(Font(R.font.tektur_semi_bold, FontWeight.SemiBold))
    val tomorrowRegular = FontFamily(Font(R.font.tomorrow_regular, FontWeight.SemiBold))
